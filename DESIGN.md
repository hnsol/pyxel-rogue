...
低HP時のHPバー枠は、赤や黄色の警告点滅ではなく、黒〜灰色だけでゆっくり脈打つ不気味な明滅にする。色列は `1,1,2,3,4,5,5,4,3,2,1,1` を5フレーム刻みで循環させ、HPバー本体の赤とは役割を分ける。枠は一瞬見えにくくなってよく、死亡後の墓画面で残って見えても「生命維持ランプがまだ脈打っている」ような余韻として許容する。
