...
def saved_monster_miss_feedback(hero_started: bool, winat_ch: str | None = None, disguise: str | None = None):
    """Rogue 5.4.4 sticks.c:fire_bolt() saved monster miss runto/message branch."""
    show = True
    if winat_ch is not None and disguise is not None:
        show = winat_ch != "M" or disguise == "M"
    return hero_started and show, show
