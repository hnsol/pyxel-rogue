...
ONLINE_UI_TEXT = {
    LANG_EN: {
        ...
        "score_hint": "Left/Right: Period  Up/Down: Diff  Select/Tab: Sync  B/Esc: Back",
        ...
        "register_previous_names": "Previous Names",
    ...
    LANG_JA: {
        ...
        "score_tab_season": "今季",
        "score_header": "   得点 名前",
        "score_hint": "左右: 期間  上下: 難易度  Select/Tab: 同期  B/Esc: 戻る",
