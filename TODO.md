...
- [ ] **杖（Wand/Staff）14種** — チャージ制、方向指定 zap、ランダム素材名で識別
  ...
  - [ ] invisibility / polymorph / teleport away / teleport to / cancellation の単体モンスター効果接続
...
- [x] 80×22メインASCIIマップを暫定640×320レイアウトで表示
...
- [ ] 可変画面 / レイアウト再計算
- [ ] 80桁表示、右HUD、下ログを 512×320 / Pyxel Web / 携帯機向けに再調整
- [x] カメラ追従開始位置の調整
