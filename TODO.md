...
- ✅ Rogue 5.4 `chase.c` / `monsters.c` / `fight.c` 寄りのモンスターAI基礎（running、起床、扉接近、R/I特殊攻撃、飛行追加移動）
...
- [x] Rattlesnake / Ice monster の Rogue 5.4 準拠寄せ（毒セーヴによるStr低下、命中時凍結）
...
- [ ] 投擲が斜め方向に未対応
- [ ] 迷路部屋 / gone room は未実装
- [ ] 通路番号付き passages / 暗い部屋 / Xeroc / 指輪・杖・cancellation とモンスターAIの完全連携
